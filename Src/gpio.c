...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, out_5_Pin|out_4_Pin|out_3_Pin|out_2_Pin
                          ...
                          |relay_5_Pin|relay_6_Pin|out_7_Pin|out_6_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, led_485_1_Pin|led_485_2_Pin|led_bms_Pin|led_ccs_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = out_5_Pin|out_4_Pin|out_3_Pin|out_2_Pin
                          |out_1_Pin|relay_2_Pin|relay_3_Pin|relay_4_Pin
                          |relay_5_Pin|relay_6_Pin|out_7_Pin|out_6_Pin;
  ...
  GPIO_InitStruct.Pin = led_485_1_Pin|led_485_2_Pin|led_bms_Pin|led_ccs_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
